...
public class CustomScanner {
    ...
    private Boolean isConstant(String token) throws FileNotFoundException {
        FiniteAutomata FA_constant = new FiniteAutomata("D:/YearIII/FLCD/Labs/Formal-Languages-and-Compiler-Design/Lab3/fa/constant");
        FA_constant.readFromFile();
        if(!FA_constant.isDFA()) {
            return false;
        }

        FiniteAutomata FA_identifier = new FiniteAutomata("D:/YearIII/FLCD/Labs/Formal-Languages-and-Compiler-Design/Lab3/fa/identifier");
    ...
    public void classifyTokens() throws IOException {
        ...
        PrintWriter pw = new PrintWriter("D:/YearIII/FLCD/Labs/Formal-Languages-and-Compiler-Design/Lab3/scanner_output/pif");
        pw.printf("%-20s %s\n", "Token", "ST_Pos");
    ...
    public void writeToSymbolTable() throws FileNotFoundException {
        PrintWriter pw = new PrintWriter("D:/YearIII/FLCD/Labs/Formal-Languages-and-Compiler-Design/Lab3/scanner_output/st");
